...
{
                    sql="insert into qbank(qid,academicyear,oddeven,subcode,unit,qno,part,sdiv,question,maxmarks,clevel,co,staffid,active) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
					ps=con.prepareStatement(sql);
					ps.setInt(1,qid);
...
public String QuestionActive(int id,int act)
{
try
{
DBConnectionManager connMgr;
...
Connection con = connMgr.getConnection("xavier");
                  ...
                  sql="update qbank set active=? where id=?";
					ps=con.prepareStatement(sql);
					ps.setInt(1,act);
					ps.setInt(2,id);
					int i = ps.executeUpdate();
...
sql="select * from qbank where active=1 and subcode='"+subcode+"' order by part,unit,qno,sdiv";
}
else
{
...
sql="select * from qbank where active=1 and unit="+unit+" and subcode='"+subcode+"' order by part,qno,sdiv";
}
...
sql="select * from qbank where active=1 and subcode='"+subcode+"' order by unit,part,qno,sdiv";
}
else
{
//sql="select * from qbank where unit="+unit+" and subcode='"+subcode+"' and academicyear='"+accyear+"' and oddeven='"+oddeven+"' order by part,qno,sdiv";
...
sql="select clevel,co,sum(maxmarks) from qbank where active=1 and subcode='"+subcode+"' group by clevel,co order by clevel";
}
else
{
...
sql="select clevel,co,sum(maxmarks) from qbank where active=1 and unit="+unit+" and subcode='"+subcode+"' group by clevel,co order by clevel";
}
rs = stmt.executeQuery(sql);
...
sql="select * from qbank where active=1 and unit="+unit+" and subcode='"+subcode+"' and academicyear='"+accyear+"' and oddeven='"+oddeven+"' order by part,qno,sdiv";
...
sql="select * from qbank where active=1 and unit="+unit+" and exam1 is not null and subcode='"+subcode+"' and academicyear='"+accyear+"' and oddeven='"+oddeven+"' order by part,qno,sdiv";
rs = stmt.executeQuery(sql);
if(rs.next()) f1=1;
rs.close();
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unit+" and subcode='"+subcode+"' and part=1 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' order by NEWID()"; 
rs = stmt.executeQuery(sql);
if(rs.next()) {
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unit+" and subcode='"+subcode+"' and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' order by NEWID()"; 
rs = stmt.executeQuery(sql);
if(rs.next()) {
    qno=Integer.parseInt(rs.getString(1));
	for(k=2;k<=6;k++)
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unit+" and subcode='"+subcode+"' and part=3 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' order by NEWID()"; 
rs = stmt.executeQuery(sql);
if(rs.next()) {
    qno=Integer.parseInt(rs.getString(1));
	for(k=2;k<=6;k++)
...
sql="select * from qbank where active=1 and unit="+unit+" and rtrim(exam1)='"+unit+"' and subcode='"+subcode+"' and academicyear='"+accyear+"' and oddeven='"+oddeven+"' order by part,exam1qno,exam1opt";
rs = stmt.executeQuery(sql);
...
sql="select * from qbank where active=1 and unit="+unita+" and exam1 is not null and subcode='"+subcode+"' and oddeven='"+oddeven+"' order by part,qno,sdiv";
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' and part=1 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' and part=1 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
sql=" select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' "
...
+" and qno <= (select max(qno)/2 from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"') "
//+" and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"') "
+" order by NEWID()";
...
sql=" select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"' " 
//+" and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' " 
+" and qno <= (select max(qno)/2 from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"') "
//+" and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"') "
+" order by NEWID()";
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' and part=3 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' and part=3 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
sql="select * from qbank where active=1 and unit in ("+unita+","+unitb+") and exam1 in ("+unita+","+unitb+") and subcode='"+subcode+"' and oddeven='"+oddeven+"' order by part,exam1qno,exam1opt";
...
{
f2=0;
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",0,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' and part=1 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",0,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' and part=1 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",1,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"' " 
//+" and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' " 
+" and qno <= (select max(qno)/2 from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"') "
...
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",2,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"' " 
//+" and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' " 
+" and qno > (select max(qno)/2 from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"') "
...
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",1,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"' " 
//+" and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' " 
+" and qno <= (select max(qno)/2 from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"') "
...
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",2,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"' " 
//+" and part=2 and exam1 is null and academicyear='"+accyear+"' and oddeven='"+oddeven+"' " 
+" and qno > (select max(qno)/2 from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' "
+" and part=2 and exam1 is null and oddeven='"+oddeven+"') "
...
{
f2=0;
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",1,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unita+" and subcode='"+subcode+"' and part=3 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
sql="select top 1 id,qid,academicyear,oddeven,subcode,unit,"+(count+1)+",part,sdiv,question,maxmarks,clevel,co,exam1,"+(count+1)+",2,exam2,exam2qno,exam2opt,staffid from qbank where active=1 and unit="+unitb+" and subcode='"+subcode+"' and part=3 and exam1 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
sql="select * from qbank where active=1 and  exam2 is not null and subcode='"+subcode+"' and oddeven='"+oddeven+"' order by part,qno,sdiv";
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co,unit from qbank where active=1 and unit="+j+" and subcode='"+subcode+"' and part=1 and exam2 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
if(f2==1)
{
sql="update qbank set exam2=?, exam2qno=?, exam2opt=0 where unit="+j+" and qno=? and subcode=? and part=1 and oddeven=? ";
					ps=con.prepareStatement(sql);
					ps.setString(1,unit+"");
					ps.setInt(2,q);
					ps.setInt(3,qno);
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co,unit from qbank where active=1 and unit="+j+" and subcode='"+subcode+"' and part=2 and exam2 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
if(f2==1)
{
sql="update qbank set exam2=?, exam2qno=?, exam2opt=1 where unit="+j+" and qno=? and subcode=? and part=2 and oddeven=? ";
					ps=con.prepareStatement(sql);
					ps.setString(1,unit+"");
					ps.setInt(2,q);
					ps.setInt(3,qno);
...
if(f2==1)
{
sql="update qbank set exam2=?, exam2qno=?, exam2opt=2 where unit="+j+" and qno=? and subcode=? and part=2 and oddeven=? ";
					ps=con.prepareStatement(sql);
					ps.setString(1,unit+"");
					ps.setInt(2,q);
					ps.setInt(3,qno);
...
{
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co,unit from qbank where active=1 and subcode='"+subcode+"' and part=3 and exam2 is null and clevel>2 and oddeven='"+oddeven+"' order by NEWID()"; 
...
if(f2==1)
{
sql="update qbank set exam2=?, exam2qno=?, exam2opt=1 where qno=? and subcode=? and part=3 and oddeven=? and unit=?";
					ps=con.prepareStatement(sql);
					ps.setString(1,unit+"");
					ps.setInt(2,q);
					ps.setInt(3,qno);
...
f2=0;
sql="select top 1 qno,sdiv,qid,maxmarks,clevel,co,unit from qbank where active=1 and subcode='"+subcode+"' and part=3 and clevel>2 and exam2 is null and oddeven='"+oddeven+"' order by NEWID()"; 
...
if(f2==1)
{
sql="update qbank set exam2=?, exam2qno=?, exam2opt=2 where qno=? and subcode=? and part=3 and oddeven=? and unit=?";
					ps=con.prepareStatement(sql);
					ps.setString(1,unit+"");
					ps.setInt(2,q);
					ps.setInt(3,qno);
...
sql="select * from qbank where active=1 and rtrim(exam2)='"+unit+"' and subcode='"+subcode+"' and oddeven='"+oddeven+"' order by part,exam2qno,exam2opt";
