...
public String BookingRemInsert()
{
sql="";
try
{
...
+" type,quota,rtrim(b.remarks),staffid,student.active,dno1,dno2,dno3,departmentno,format(bookingdate,'dd/MM/yyyy') "
+" from student,bookingrem b,stud where stud.rollno=student.rollno and bookingid=student.rollno and academicyear='"+repin[1]+"' "
+" and directorlateral='Direct' and departmentno in ("+repin[2]+") and religion in  ("+repin[3]+") and type in  ("+repin[4]+") and student.active in  ("+repin[5]+") "+repin[7];
