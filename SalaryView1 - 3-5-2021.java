...
//	            if(esiper>0.0) esieper=4.75f; else esieper=0;
				...
				if (staffid[i].equals("NS103")) { esi[i]=0;   esie[i]=0; 			}
				if (staffid[i].equals("NS075")) { esi[i]=0;   esie[i]=0; 			}
				if (staffid[i].equals("NS137")) { esi[i]=0;   esie[i]=0; 			}
				if (staffid[i].equals("NS139")) { esi[i]=0;   esie[i]=0; 			}
