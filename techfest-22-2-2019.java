...
+"len('000'+ltrim(rtrim(str(month(adate)))))-1,2)+'/'+ ltrim(rtrim(str(year(adate)))) from techfest where rollno="+repin[1]+" and cyear="+cyear;
...
public String techfestAllList(String fd, String td,int act)
{
int i=0;
count=0;
...
+"len('000'+ltrim(rtrim(str(month(date)))))-1,2)+'/'+ ltrim(rtrim(str(year(date)))),type,details,action, "
+"substring(('000'+ltrim(rtrim(str(day(adate))))), len('000'+ltrim(rtrim(str(day(adate)))))-1,2)+'/'+  substring(('000'+ltrim(rtrim(str(month(adate))))), "
+"len('000'+ltrim(rtrim(str(month(adate)))))-1,2)+'/'+ ltrim(rtrim(str(year(adate)))),name,sf from techfest,student,department where student.rollno=techfest.rollno and department.dno=student.departmentno "
+"and date between '"+date1+"' and '"+date2+"' and type in("+repin[10]+") and departmentno in ("+repin[9]+") and cyear="+cyear+" and action is null";
else
sql="select id,student.rollno,substring(('000'+ltrim(rtrim(str(day(date))))), len('000'+ltrim(rtrim(str(day(date)))))-1,2)+'/'+  substring(('000'+ltrim(rtrim(str(month(date))))), "
+"len('000'+ltrim(rtrim(str(month(date)))))-1,2)+'/'+ ltrim(rtrim(str(year(date)))),type,details,action, "
+"substring(('000'+ltrim(rtrim(str(day(adate))))), len('000'+ltrim(rtrim(str(day(adate)))))-1,2)+'/'+  substring(('000'+ltrim(rtrim(str(month(adate))))), "
+"len('000'+ltrim(rtrim(str(month(adate)))))-1,2)+'/'+ ltrim(rtrim(str(year(adate)))),name,sf from techfest,student,department where student.rollno=techfest.rollno and department.dno=student.departmentno "
+"and date between '"+date1+"' and '"+date2+"' and type in("+repin[10]+")  and cyear="+cyear+" and departmentno in ("+repin[9]+")";
